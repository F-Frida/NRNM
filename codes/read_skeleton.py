...
def gendata(data_path, out_path, ignored_sample_path=None, benchmark='xview', part='eval'):
    ...
    fp = fp.transpose(0,2,4,1,3).reshape(fp.shape[0],100,150)
    np.save('{}/{}_data_joint.npy'.format(out_path, part), fp)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='NTU-RGB-D Data Converter.')
    parser.add_argument('--data_path', default='../../datasets/Skeleton/nturgb+d_skeletons/')
    parser.add_argument('--ignored_sample_path',
                        default='samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='../../datasets/Skeleton/skeletons_npy2/')
