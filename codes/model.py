...
import ho_rnn as ho_rnn
import EleAtt_LSTM as EleAtt_LSTM
import EleAtt_GRU as EleAtt_GRU
memory_cell_type = 7
print('memory_cell_type =', memory_cell_type)
if memory_cell_type == 1:
    import memory_cell as memory_cell
if memory_cell_type == 2:
    import memory_cell_v2 as memory_cell
if memory_cell_type == 3:
    import memory_cell_multi as memory_cell
if memory_cell_type == 4:
    import memory_cell_multi_v2 as memory_cell
if memory_cell_type == 5:
    import memory_cell_multi_v3 as memory_cell
if memory_cell_type == 6:
    import memory_cell_multi_v4 as memory_cell
if memory_cell_type == 7:
    import memory_cell_multi_zonout as memory_cell
if memory_cell_type == 8:
    import memory_cell_mixm as memory_cell
if memory_cell_type == 9:
    import memory_cell_mixmzonout as memory_cell
if memory_cell_type == 10:
    import memory_cell_mixmzonout_memorymask as memory_cell
if memory_cell_type == 11:   # for draw fig.
    import memory_cell_view as memory_cell
