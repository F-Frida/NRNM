...
parser.add_argument('--my', nargs='+', type=int, default=[1],
...
print("*********")
batch_size = 256
data_path = '../datasets/skeletons_npy/'
...
dset_test_loaders = DataLoader(dataset=dsets_test, num_workers=64, batch_size=256, shuffle=False)
...
if args.ft:
    ...
    modelft_dir = 'checkpoint/CS/myMEM_LSTM_3_orglstm/'
    modelft_file1 = modelft_dir + 'MEM_LSTM_epoch_54.pth'
...
if __name__ == "__main__":
    if args.phase == 'TRAIN':
        ...
        modelft_dir = 'checkpoint/{}/myMEM_LSTM_3_v_s4b8_3layer_z2_wd001_mix01_256_0307_ft/'.format(args.data_mode)
        modelft_file1 = modelft_dir + 'MEM_LSTM_epoch_1449.pth'
