...
class MemoryCell(nn.Module):
    ...
    def __init__(self,
        ...
        self.easy_projector = nn.Linear(self.mem_size, self.mem_size)
        #self.easy_layernorm = nn.LayerNorm([self.mem_slots_plus_input, self.total_qkv_size])
    ...
    #     qkv = self.easy_projector(memory)
    #     return qkv
    #'''
    def multihead_attention(self, memory):
        """
