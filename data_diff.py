...
def loadsubject_data(data_path):
    train_data = np.empty((40091, 100, 300))
    test_data = np.empty((16487, 100, 300))
    ...
    for i in range(num):
        ...
        one_data = one_data['skeleton_diff']
...
def loadview_data(data_path):
    train_data = np.empty((37646, 100, 300))
    test_data = np.empty((18932, 100, 300))
